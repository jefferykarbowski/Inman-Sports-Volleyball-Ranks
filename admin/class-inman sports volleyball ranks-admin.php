...
class Inman_Sports_Volleyball_Ranks_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Inman_Sports_Volleyball_Ranks_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Inman_Sports_Volleyball_Ranks_Loader will then create the relationship
