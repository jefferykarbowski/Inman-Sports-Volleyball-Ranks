<?php
namespace Inman_Sports_Volleyball_Ranks_Admin\Widgets;
...
class Inman_Video_Playlist extends Base_Widget {

	public function get_name() {
		return 'inman-video-playlist';
	}

	public function get_title() {
		return esc_html__( 'Inman Video Playlist', 'elementor-pro' );
	}
